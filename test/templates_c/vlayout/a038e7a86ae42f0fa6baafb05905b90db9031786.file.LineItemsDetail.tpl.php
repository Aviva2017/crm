<?php /* Smarty version Smarty-3.1.7, created on 2017-12-21 12:48:41
         compiled from "/home/www/Aviva/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsDetail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10551030145a3bada9b0a543-07092891%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a038e7a86ae42f0fa6baafb05905b90db9031786' => 
    array (
      0 => '/home/www/Aviva/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsDetail.tpl',
      1 => 1513840659,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10551030145a3bada9b0a543-07092891',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3bada9cce6b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3bada9cce6b')) {function content_5a3bada9cce6b($_smarty_tpl) {?>
...
(<?php echo $_smarty_tpl->tpl_vars['CURRENCY_INFO']->value['currency_symbol'];?>
    ...
    <th colspan="2" class="detailViewBlockHeader">
		<span class="<?php if (count($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["taxes"])==0){?>hide<?php }?>">
...
"><?php echo vtranslate('LBL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
	    ...
	    <tr>
	    <?php if ($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value['taxtype']=='group'){?>
		<tr class="<?php if (count($_smarty_tpl->tpl_vars['FINAL_DETAILS']->value["taxes"])==0){?>hide<?php }?>">
		    <td width="83%">
			<span class="pull-right">
			    <?php ob_start();?><?php echo vtranslate('LBL_TOTAL_AFTER_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
