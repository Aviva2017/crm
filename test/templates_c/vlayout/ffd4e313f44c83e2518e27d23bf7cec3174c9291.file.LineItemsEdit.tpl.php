<?php /* Smarty version Smarty-3.1.7, created on 2017-12-21 13:19:19
         compiled from "/home/www/Aviva/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7599546955a3bb4d7e80ce9-73344021%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ffd4e313f44c83e2518e27d23bf7cec3174c9291' => 
    array (
      0 => '/home/www/Aviva/includes/runtime/../../layouts/vlayout/modules/Inventory/LineItemsEdit.tpl',
      1 => 1513825786,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7599546955a3bb4d7e80ce9-73344021',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a3bb4d81927d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3bb4d81927d')) {function content_5a3bb4d81927d($_smarty_tpl) {?>
...
" /></div></th><th colspan="2" class="chznDropDown"><div class="row-fluid <?php if (count($_smarty_tpl->tpl_vars['TAXES']->value)==0){?>hide<?php }?>"><div class="inventoryLineItemHeader"><span class="alignTop"><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?>"/></td></tr><!-- Group Tax - starts --><tr id="group_tax_row" valign="top" class="<?php if (count($_smarty_tpl->tpl_vars['TAXES']->value)==0){?>hide<?php }?> <?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value){?>hide<?php }?>"><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="finalTax"><?php echo vtranslate('LBL_TAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?>0<?php }?></span></td></tr><!-- Group Tax - ends --><tr class="<?php if (count($_smarty_tpl->tpl_vars['SHIPPING_TAXES']->value)==0){?>hide<?php }?>"><td width="83%"><span class="pull-right">(+)&nbsp;<b><a href="javascript:void(0)" id="shippingHandlingTax"><?php echo vtranslate('LBL_TAX_FOR_SHIPPING_AND_HANDLING',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</span></td></tr><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Invoice'){?><tr valign="top"><td width="83%" ><div class="pull-right"><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Invoice'){?><b><?php echo vtranslate('LBL_RECEIVED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
