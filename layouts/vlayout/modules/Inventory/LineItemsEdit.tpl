...
{strip}
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
            ...
            <th colspan="2" class="chznDropDown">
                <div class="row-fluid {if count($TAXES) == 0}hide{/if}">
    ...
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemResult">
		...
		<!-- Group Tax - starts -->
        <tr id="group_tax_row" valign="top" class="{if count($TAXES) == 0}hide{/if} {if $IS_INDIVIDUAL_TAX_TYPE}hide{/if}">
            <td width="83%">
        ...
        <!-- Group Tax - ends -->
        <tr class="{if count($SHIPPING_TAXES) == 0}hide{/if}">
            <td width="83%">
