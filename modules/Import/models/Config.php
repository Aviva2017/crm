	...
	function __construct() {
		$ImportConfig = array(
			'importTypes' => array(
								...
								'xls' => array('reader' => 'Import_ExcelReader_Reader', 'classpath' => 'modules/Import/readers/ExcelReader.php'),
                                'xlsx' => array('reader' => 'Import_ExcelReader_Reader', 'classpath' => 'modules/Import/readers/ExcelReader.php'),
